...
import { filterOptions } from "../../utils/filterBarOptions"; // Ensure this file contains appropriate product filter options
                ...
                <ul className="text-xl pt-10 text-right">
                    {filterOptions.map((btn) => {
                        return (
                            <FilterBtnSidebar
                                key={btn.name}
                                {...btn} // Assuming FilterBtnSidebar accepts props like name, type, etc.
                            />
                        );
                    })}
                    <SortSidebarBtn />
